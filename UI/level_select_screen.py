...
class LevelSelectScreen:
       ...
       for e in events:
           if e.type == pygame.KEYDOWN and e.key == pygame.K_m:
               ...
               if self.main_btn.collidepoint(e.pos):
                   self.screen_manager.switch("main")
           # elif e.type == pygame.MOUSEBUTTONDOWN:
           #     if self.level_1_button.collidepoint(e.pos):
   ...
   def draw(self, screen):
       ...
       screen.blit(self.font.render("Continue", True, Variables.WHITE), (self.continue_button.x+19,self.continue_button.y+15))
