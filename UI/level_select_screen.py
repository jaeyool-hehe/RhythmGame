...
class LevelSelectScreen:
    ...
    def draw(self, screen):
        ...
        pygame.draw.rect(screen, Variables.WHITE, self.continue_btn, border_radius=20, width=2)
        ...
        screen.blit(Variables.BUTTON_FONT.render("Continue", True, Variables.WHITE), (self.continue_btn.x + 19, self.continue_btn.y + 15))
        screen.blit(Variables.LOGO_FONT.render("Select Level", True, Variables.WHITE), (450, 100))
        screen.blit(Variables.BUTTON_FONT.render("Level 1", True, level_color(1)), (237, 215))
        screen.blit(Variables.BUTTON_FONT.render("Level 2", True, level_color(2)), (237, 315))
        screen.blit(Variables.BUTTON_FONT.render("Level 3", True, level_color(3)), (237, 415))
        screen.blit(Variables.BUTTON_FONT.render("Level 4", True, level_color(4)), (237, 515))
        screen.blit(Variables.BUTTON_FONT.render("Level 5", True, level_color(5)), (237, 615))
